...
kcn has the node type of "cn" internally and following commands and options are available.
...
KLAY OPTIONS:
  ...
  --datadir "/Users/andylee/Library/KCN"  Data directory for the databases and keystore
