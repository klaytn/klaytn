...
var (
	...
	nodeFlags = append(nodecmd.CommonNodeFlags, nodecmd.KSENFlags...)

	rpcFlags = nodecmd.CommonRPCFlags
)

var senHelpFlagGroups = []utils.FlagGroup{
	{
		Name: "KLAY",
		Flags: []cli.Flag{
			utils.DbTypeFlag,
	...
	},
	{
		...
		Flags: []cli.Flag{
			...
			utils.ServiceChainKASAnchorUrlFlag,
			utils.ServiceChainKASAnchorOperatorFlag,
			utils.ServiceChainKASAccessKeyFlag,
			utils.ServiceChainKASSecreteKeyFlag,
			utils.ServiceChainKASXKRNFlag,
		},
	},
	{
		Name: "ACCOUNT",
...
func init() {
	...
	cli.HelpPrinter = utils.NewHelpPrinter(senHelpFlagGroups)
