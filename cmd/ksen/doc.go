...
ksen has the node type of "en" internally and following commands and options are available.
...
KLAY OPTIONS:
  ...
  --datadir "/Users/andylee/Library/KSEN"  Data directory for the databases and keystore
