...
kpn has the node type of "pn" internally and following commands and options are available.
...
KLAY OPTIONS:
  ...
  --datadir "/Users/andylee/Library/KPN"  Data directory for the databases and keystore
