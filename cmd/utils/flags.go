...
var (
	...
	TrieNodeCacheNumPrefetchFlag = cli.IntFlag{
		Name:  "statedb.cache.numprefetch",
		Usage: "Number of blocks to prefetch at a time",
		Value: 1,
	}
...
func SetKlayConfig(ctx *cli.Context, stack *node.Node, cfg *cn.Config) {
	...
	cfg.TrieNodeCacheConfig = statedb.TrieNodeCacheConfig{
		...
		NumPrefetch:               ctx.GlobalInt(TrieNodeCacheNumPrefetchFlag.Name),
