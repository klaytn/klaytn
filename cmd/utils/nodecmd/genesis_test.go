...
var customGenesisTests = []struct {
	...
	},
	{
		...
		query:  []string{"klay.getBlock(0).parentHash", "klay.getBlock(0).blockScore", "klay.getBlock(0).extraData", "governance.chainConfigAt().chainId", "governance.chainConfigAt().deriveShaImpl", "governance.chainConfigAt().unitPrice", "governance.chainConfigAt().governance.governanceMode", "governance.chainConfigAt().governance.governingNode", "governance.chainConfigAt().governance.reward.deferredTxFee", "governance.chainConfigAt().governance.reward.minimumStake", "governance.chainConfigAt().governance.reward.mintingAmount", "governance.chainConfigAt().governance.reward.proposerUpdateInterval", "governance.chainConfigAt().governance.reward.ratio", "governance.chainConfigAt().governance.reward.stakingUpdateInterval", "governance.chainConfigAt().governance.reward.useGiniCoeff", "governance.chainConfigAt().istanbul.epoch", "governance.chainConfigAt().istanbul.policy", "governance.chainConfigAt().istanbul.sub"},
