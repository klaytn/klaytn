...
//
// This file is derived from doc.go (2018/06/04).
...
to serialize objects in Klaytn. The only purpose of RLP is to encode
structure; encoding specific atomic data types (eg. strings, ints,
floats) is left up to higher-order protocols; in Klaytn integers
