...
//
// This file is derived from p2p/simulations/adapters/inproc.go (2018/06/04).
...
func (sn *SimNode) Node() *discover.Node {
	return discover.NewNode(sn.ID, net.IP{127, 0, 0, 1}, 30303, 30303, nil, discover.NodeTypeUnknown)
}
