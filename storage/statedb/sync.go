...
type TrieSync struct {
	database StateTrieDB              // Persistent database to check for existing entries
...
func NewTrieSync(root common.Hash, database StateTrieDB, callback LeafCallback) *TrieSync {
	ts := &TrieSync{
		database: database,
