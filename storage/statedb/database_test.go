...
func TestDatabase_Reference(t *testing.T) {
	...
	db := NewDatabaseWithNewCache(memDB, TrieNodeCacheConfig{LocalCache, 128, nil, false})
...
func TestCache(t *testing.T) {
	memDB := database.NewMemoryDBManager()
	db := NewDatabaseWithNewCache(memDB, TrieNodeCacheConfig{LocalCache, 10, nil, false})
