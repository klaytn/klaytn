...
func TestDatabase_Reference(t *testing.T) {
	...
	db := NewDatabaseWithNewCache(memDB, TrieNodeCacheConfig{CacheTypeFast, 128, nil, false})
...
func TestCache(t *testing.T) {
	memDB := database.NewMemoryDBManager()
	db := NewDatabaseWithNewCache(memDB, TrieNodeCacheConfig{CacheTypeFast, 10, nil, false})
