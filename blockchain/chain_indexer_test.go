...
//
// This file is derived from core/chain_indexer_test.go (2018/06/04).
...
func testChainIndexer(t *testing.T, count int) {
	...
	for i := 0; i < count; i++ {
		...
		backends[i].indexer = NewChainIndexer(db, db, backends[i], sectionSize, confirmsReq, 0, fmt.Sprintf("indexer-%d", i))
