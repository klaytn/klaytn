...
/*
Package state provides a caching layer atop the Klaytn state trie.
...
stateObject represents a Klaytn account which is being modified. It is identified by its address.
