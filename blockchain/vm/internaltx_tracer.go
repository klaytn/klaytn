...
func (t *InternalTxTracer) CaptureState(env *EVM, pc uint64, op OpCode, gas, cost, cc uint64, scope *ScopeContext, depth int, err error) {
	if t.err == nil {
...
func (t *InternalTxTracer) CaptureFault(env *EVM, pc uint64, op OpCode, gas, cost, cc uint64, scope *ScopeContext, depth int, err error) {
	if t.err == nil {
