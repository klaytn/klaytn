...
//
// This file is derived from eth/downloader/testchain_test.go (2018/06/04).
...
var (
	...
	testGenesis = blockchain.GenesisBlockForTesting(testDB, testAddress, big.NewInt(1000000000))
)
