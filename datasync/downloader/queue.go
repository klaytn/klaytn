...
type queue struct {
	...
	blockDonePool  map[common.Hash]struct{}      // [klay/62] Set of the completed block (body) fetches
	...
	receiptDonePool  map[common.Hash]struct{}      // [klay/63] Set of the completed receipt fetches
