...
//
// This file is derived from eth/fetcher/fetcher_test.go (2018/06/04).
...
var (
	...
	unknownBlock = types.NewTestBlock(&types.Header{}, nil, nil, nil)
)
...
func TestDistantPropagationDiscarding(t *testing.T) {
	...
	low, high := len(hashes)/2, len(hashes)/2-maxQueueDist-1
...
// TODO-FIX-GX All tests failed due to timeout.
/*
