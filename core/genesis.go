...
func SetupGenesisBlock(db gxdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
...
func (g *Genesis) ToBlock(db gxdb.Database) *types.Block {
	if db == nil {
...
func (g *Genesis) Commit(db gxdb.Database) (*types.Block, error) {
	block := g.ToBlock(db)
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db gxdb.Database) *types.Block {
...
func GenesisBlockForTesting(db gxdb.Database, addr common.Address, balance *big.Int) *types.Block {
