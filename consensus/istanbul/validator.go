...
type ValidatorSet interface {
	...
	SubList(prevHash common.Hash, view *View, isIstanbul bool) []Validator
	// Return whether the given address is one of sub-list
	CheckInSubList(prevHash common.Hash, view *View, addr common.Address, isIstanbul bool) bool
	// SubListWithProposer composes a committee with given parameters.
	SubListWithProposer(prevHash common.Hash, proposer common.Address, view *View, isIstanbul bool) []Validator
