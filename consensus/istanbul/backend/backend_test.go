...
var (
	...
	committeeBlocks = map[Pair]bool{
		...
		{Sequence: 1, Round: 2}:   false,
		{Sequence: 2, Round: 7}:   false,
		{Sequence: 2, Round: 9}:   false,
		{Sequence: 3, Round: 2}:   false,
		{Sequence: 3, Round: 3}:   false,
		{Sequence: 3, Round: 6}:   false,
		{Sequence: 3, Round: 8}:   false,
		{Sequence: 3, Round: 9}:   false,
		{Sequence: 4, Round: 3}:   false,
		{Sequence: 4, Round: 4}:   false,
		{Sequence: 4, Round: 8}:   false,
		{Sequence: 4, Round: 12}:  false,
		{Sequence: 4, Round: 14}:  false,
...
func Test_GossipSubPeerTargets(t *testing.T) {
	_, backend := newBlockChain(1, istanbulCompatibleBlock(big.NewInt(0)))
	defer backend.Stop()
...
func newTestBackend() (b *backend) {
	...
	return newTestBackendWithConfig(config)
}
