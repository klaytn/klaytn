...
func TestNextBlockBaseFeeWhenGovernanceUpdated(t *testing.T) {
	tests := []struct {
		...
		{750000000000, 25000000000, 40000000, 750000000000, 750000000000}, // parentGasUsed(40000000) is bigger than gasTarget(30000000)
		{750000000000, 25000000000, 20000000, 25000000000, 25000000000}, // parentGasUsed(20000000) is bigger than gasTarget(30000000)
	}
	for i, test := range tests {
