...
const KIP17URIStorageMock = artifacts.require('KIP17URIStorageMock');

contract('KIP17URIStorage', function (accounts) {
  ...
  beforeEach(async function () {
    this.token = await KIP17URIStorageMock.new(name, symbol);
  });
  ...
  describe('token URI', function () {
    ...
    it('reverts when setting for non existent token id', async function () {
      await expectRevert(
        ...
        'KIP17URIStorage: URI set of nonexistent token',
      );
    });
