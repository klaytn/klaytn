...
const KIP17BurnableMock = artifacts.require('KIP17BurnableMock');

contract('KIP17Burnable', function (accounts) {
  ...
  beforeEach(async function () {
    this.token = await KIP17BurnableMock.new(name, symbol);
  });

  describe('like a burnable KIP17', function () {
    beforeEach(async function () {
