...
const KIP7DecimalsMock = artifacts.require('KIP7DecimalsMock');
...
contract('KIP7', function (accounts) {
  ...
  describe('set decimals', function () {
    ...
    it('can set decimals during construction', async function () {
      const token = await KIP7DecimalsMock.new(name, symbol, decimals);
    ...
    describe('when the spender is the zero address', function () {
      ...
      it('reverts', async function () {
        await expectRevert(
          ...
          'KIP7: approve to the zero address',
        );
      });
    });
  });
      ...
      const describeBurn = function (description, amount) {
        describe(description, function () {
          ...
          it('decrements totalSupply', async function () {
            ...
            ).to.be.bignumber.equal(expectedSupply);
          });
