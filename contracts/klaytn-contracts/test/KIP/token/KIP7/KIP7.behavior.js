...
const RECEIVER_MAGIC_VALUE = '0x9d188c22';
...
function shouldBehaveLikeKIP7 (
  ...
  describe('safeTransfer', function () {
    shouldBehaveLikeKIP7SafeTransfer(
      errorPrefix,
      initialHolder,
      recipient,
      initialSupply,
      function (from, to, value) {
        return this.token.safeTransfer(to, value, { from });
      },
    );
  });
    ...
    describe('when the token owner is not the zero address', function () {
      ...
      describe('when the recipient is not the zero address', function () {
        ...
        describe('when the spender has enough allowance', function () {
          ...
          describe('when the token owner does not have enough balance', function () {
            ...
            beforeEach('reducing balance', async function () {
              await this.token.transfer(to, 1, {
                from: tokenOwner,
              });
            });
        ...
        describe('when the spender does not have enough allowance', function () {
          ...
          beforeEach(async function () {
            await this.token.approve(spender, allowance, {
              from: tokenOwner,
            });
          });
          ...
          describe('when the token owner does not have enough balance', function () {
            ...
            beforeEach('reducing balance', async function () {
              await this.token.transfer(to, 2, {
                from: tokenOwner,
              });
            });
        ...
        describe('when the spender has unlimited allowance', function () {
          beforeEach(async function () {
            await this.token.approve(spender, MAX_UINT256, {
              from: initialHolder,
            });
          });

          it('does not decrease the spender allowance', async function () {
            await this.token.transferFrom(tokenOwner, to, 1, {
              from: spender,
            });
...
function shouldBehaveLikeKIP7Transfer (
  errorPrefix,
  from,
  to,
  balance,
...
function shouldBehaveLikeKIP7SafeTransfer (
  errorPrefix,
  from,
  to,
  balance,
  ...
  describe('when the recipient is not the zero address', function () {
    describe('when the sender does not have enough balance', function () {
      ...
      it('reverts', async function () {
        await expectRevert(
          safeTransfer.call(this, from, to, amount),
          `${errorPrefix}: transfer amount exceeds balance`,
        );
      });
    });
    ...
    describe('when the sender transfers all balance', function () {
      const amount = balance;
      it('transfers the requested amount', async function () {
        await safeTransfer.call(this, from, to, amount);
    ...
    describe('to a valid receiver contract', function () {
      ...
      it('calls onKIP7Received', async function () {
        const receipt = await safeTransfer.call(
          this,
          from,
  ...
  describe('when the recipient is the zero address', function () {
    it('reverts', async function () {
      await expectRevert(
        safeTransfer.call(this, from, ZERO_ADDRESS, balance),
        `${errorPrefix}: transfer to the zero address`,
      );
    });
  });
...
function shouldBehaveLikeKIP7Approve (
  errorPrefix,
  owner,
  spender,
  supply,
