...
const KIP7VotesMock = artifacts.require('KIP7VotesMock')
...
contract('KIP7Votes', function (accounts) {
    const [
        holder,
        recipient,
        holderDelegatee,
    ...
    beforeEach(async function () {
        this.token = await KIP7VotesMock.new(name, symbol)
    ...
    describe('set delegation', function () {
        describe('call', function () {
            it('delegation with balance', async function () {
                ...
                expect(await this.token.getVotes(holder)).to.be.bignumber.equal(
                    supply
                )
                expect(
                ...
                expect(
                    await this.token.getPastVotes(holder, receipt.blockNumber)
        ...
        describe('with signature', function () {
            ...
            it('accept signed delegation', async function () {
                ...
                expect(
                    await this.token.getVotes(delegatorAddress)
                ).to.be.bignumber.equal(supply)
                expect(
                    await this.token.getPastVotes(
                        delegatorAddress,
    ...
    describe('change delegation', function () {
        ...
        it('call', async function () {
            ...
            expect(
                await this.token.getVotes(holderDelegatee)
            ).to.be.bignumber.equal(supply)
            expect(
    ...
    describe('transfers', function () {
        ...
        it('sender delegation', async function () {
            ...
            const { logIndex: transferLogIndex } = receipt.logs.find(
        ...
        afterEach(async function () {
            ...
            expect(await this.token.getVotes(recipient)).to.be.bignumber.equal(
                this.recipientVotes
            )
            ...
            await time.advanceBlock()
            expect(
                await this.token.getPastVotes(holder, blockNumber)
            ).to.be.bignumber.equal(this.holderVotes)
            expect(
                await this.token.getPastVotes(recipient, blockNumber)
    ...
    describe('Compound test suite', function () {
        ...
        describe('getPastVotes', function () {
            ...
            it('returns 0 if there are no checkpoints', async function () {
                expect(
                    await this.token.getPastVotes(other1, 0)
                ).to.be.bignumber.equal('0')
            })
