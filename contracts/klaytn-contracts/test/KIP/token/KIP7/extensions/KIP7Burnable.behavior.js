  ...
  describe('burnFrom', function () {
    describe('on success', function () {
      ...
      function shouldBurnFrom (amount) {
        ...
        beforeEach(async function () {
          await this.token.approve(burner, originalAllowance, {
            from: owner,
          });
        ...
        it('decrements allowance', async function () {
          expect(
            await this.token.allowance(owner, burner),
          ).to.be.bignumber.equal(originalAllowance.sub(amount));
        });
    ...
    describe('when the given amount is greater than the allowance', function () {
      ...
      it('reverts', async function () {
        ...
        await expectRevert(
          this.token.burnFrom(owner, allowance.addn(1), {
            from: burner,
          }),
