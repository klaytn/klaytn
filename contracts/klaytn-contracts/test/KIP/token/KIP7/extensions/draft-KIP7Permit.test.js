...
const KIP7PermitMock = artifacts.require('KIP7PermitMock')
...
contract('KIP7Permit', function (accounts) {
    ...
    beforeEach(async function () {
        this.token = await KIP7PermitMock.new(
            name,
            symbol,
            initialHolder,
            initialSupply
    ...
    it('initial nonce is 0', async function () {
        expect(await this.token.nonces(initialHolder)).to.be.bignumber.equal(
            '0'
        )
    })
