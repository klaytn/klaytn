...
const KIP7PresetFixedSupply = artifacts.require('KIP7PresetFixedSupply');

contract('KIP7PresetFixedSupply', function (accounts) {
  ...
  before(async function () {
    this.token = await KIP7PresetFixedSupply.new(
      name,
      symbol,
      initialSupply,
      owner,
