...
var isTxField = func() map[types.TxType]map[string]bool {
	...
	var internalDataTypes = map[types.TxType]interface{}{
		...
		types.TxTypeAccountStatusUpdate:                         types.TxInternalDataAccountStatusUpdate{},
	}
...
func (args *SendTxArgs) genTxValuesMap() map[types.TxValueKeyType]interface{} {
	...
	if args.AccountStatus != nil {
		values[types.TxValueKeyAccountStatus] = uint64(*args.AccountStatus)
	}
	if args.Key != nil {
