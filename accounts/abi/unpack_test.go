...
//
// This file is derived from accounts/abi/unpack_test.go (2018/06/04).
...
var unpackTests = []unpackTest{
	...
	{
		def:  `[{"type": "string[4]"}]`,
		enc:  "",
		want: [4]string{"Hello", "World", "Go-klaytn", "Klaytn"},
	},
	{
		def:  `[{"type": "string[]"}]`,
		enc:  "",
		want: []string{"Klaytn", "go-klaytn"},
	},
	{
		def:  `[{"type": "int8[]"}]`,
		enc:  "",
...
func TestMultiReturnWithStringArray(t *testing.T) {
	...
	buff := new(bytes.Buffer)
	buff.Write(common.Hex2Bytes(""))
	temp, _ := big.NewInt(0).SetString("30000000000000000000", 10)
	ret1, ret1Exp := new([3]*big.Int), [3]*big.Int{big.NewInt(1545304298), big.NewInt(6), temp}
	ret2, ret2Exp := new(common.Address), common.HexToAddress("ab1257528b3782fb40d7ed5f72e624b744dffb2f")
	ret3, ret3Exp := new([2]string), [2]string{"Klaytn", "Hello, Klaytn!"}
...
func TestMultiReturnWithStringSlice(t *testing.T) {
	...
	buff := new(bytes.Buffer)
	buff.Write(common.Hex2Bytes(""))
	ret1, ret1Exp := new([]string), []string{"Klaytn", "go-Klaytn"}
