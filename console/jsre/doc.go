...
And JSRE also provides two Javascript libraries, bignumber.js and web3.js, for users to easily access Klaytn.
...
Each file provides following features
 ...
 - pretty.go	: Print result to the standard output in more readable way
*/
package jsre
