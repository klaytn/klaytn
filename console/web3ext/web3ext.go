...
web3._extend({
	...
	[
		...
		new web3._extend.Method({
			name: 'getParentBridgeOperatorGasLimit',
			call: 'subbridge_getParentBridgeOperatorGasLimit',
			params: 0
		}),
		new web3._extend.Method({
			name: 'getChildBridgeOperatorGasLimit',
			call: 'subbridge_getChildBridgeOperatorGasLimit',
			params: 0
		}),
		new web3._extend.Method({
