...
func (ec *Client) TransactionSender(ctx context.Context, tx *types.Transaction, block common.Hash, index uint) (common.Address, error) {
	...
	if err = ec.c.CallContext(ctx, &meta, "kaia_getTransactionByBlockHashAndIndex", block, hexutil.Uint64(index)); err != nil {
...
func (ec *Client) ChainID(ctx context.Context) (*big.Int, error) {
	...
	var result hexutil.Big
	err := ec.c.CallContext(ctx, &result, "kaia_chainID")
	if err == nil {
...
func (ec *Client) CreateAccessList(ctx context.Context, msg kaia.CallMsg) (*types.AccessList, uint64, string, error) {
	...
	if err := ec.c.CallContext(ctx, &result, "kaia_createAccessList", toCallArg(msg)); err != nil {
		return nil, 0, "", err
	}
