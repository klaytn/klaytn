...
IF DEFINED TXPOOL_GLOBAL_SLOTS (
    set OPTIONS=%OPTIONS% --txpool.globalslots %TXPOOL_GLOBAL_SLOTS%
)

IF DEFINED TXPOOL_GLOBAL_QUEUE (
    set OPTIONS=%OPTIONS% --txpool.globalqueue %TXPOOL_GLOBAL_QUEUE%
)

IF DEFINED TXPOOL_ACCOUNT_SLOTS (
    set OPTIONS=%OPTIONS% --txpool.accountslots %TXPOOL_ACCOUNT_SLOTS%
)

IF DEFINED TXPOOL_ACCOUNT_QUEUE (
    set OPTIONS=%OPTIONS% --txpool.accountqueue %TXPOOL_ACCOUNT_QUEUE%
)
