...
//
// This file is derived from core/state/snapshot/account.go (2021/10/21).
...
/*
  TODO-snapshot
  The following account model is for legacy account model from ethereum
  The encoding/decoding account model should be handled in a different way from ethereum to update account trie
  Refactor it after snapshot implementation
*/
