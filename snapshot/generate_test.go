...
func TestGenerateCorruptAccountTrie(t *testing.T) {
	...
	stateTrieDB := diskdb.GetDatabase(database.StateTrieDB)
	stateTrieDB.Delete(common.HexToHash("0x65145f923027566669a1ae5ccac66f945b55ff6eaeb17d2ea8e048b7d381f2d7").Bytes())
...
func TestGenerateMissingStorageTrie(t *testing.T) {
	...
	stateTrieDB := diskdb.GetDatabase(database.StateTrieDB)
	stateTrieDB.Delete(common.HexToHash("0xddefcd9376dd029653ef384bd2f0a126bb755fe84fdcc9e7cf421ba454f2bc67").Bytes())
...
func TestGenerateCorruptStorageTrie(t *testing.T) {
	...
	stateTrieDB := diskdb.GetDatabase(database.StateTrieDB)
	stateTrieDB.Delete(common.HexToHash("0x18a0f4d79cff4459642dd7604f303886ad9d77c30cf3d7d7cedb3a693ab6d371").Bytes())
