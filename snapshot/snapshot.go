...
var (
	...
	// TODO-Klaytn - it is NewRegisteredResettingTimer at geth
	snapshotBloomIndexTimer = metrics.NewRegisteredTimer("state/snapshot/bloom/index", nil)
...
// SnapshotTree is a Klaytn state snapshot tree. It consists of one persistent
...
func New(diskdb database.DBManager, triedb *statedb.Database, cache int, root common.Hash, async bool, recovery bool) *Tree {
...
func diffToDisk(bottom *diffLayer) *diskLayer {
	...
	for hash := range bottom.destructSet {
		...
		it := base.diskdb.IterateStorageSnapshots(hash)
		for it.Next() {
