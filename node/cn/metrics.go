...
var (
	...
	propConsensusInPacketsMeter  = metrics.NewRegisteredMeter("klay/prop/consensus/in/packets", nil)
	propConsensusInTrafficMeter  = metrics.NewRegisteredMeter("klay/prop/consensus/in/traffic", nil)
	propConsensusOutPacketsMeter = metrics.NewRegisteredMeter("klay/prop/consensus/out/packets", nil)
	propConsensusOutTrafficMeter = metrics.NewRegisteredMeter("klay/prop/consensus/out/traffic", nil)
)
...
func (rw *meteredMsgReadWriter) ReadMsg() (p2p.Msg, error) {
	...
	case msg.Code == backend.IstanbulMsg:
		packets, traffic = propConsensusInPacketsMeter, propConsensusInTrafficMeter
	}
	packets.Mark(1)
...
func (rw *meteredMsgReadWriter) WriteMsg(msg p2p.Msg) error {
	...
	case msg.Code == backend.IstanbulMsg:
		packets, traffic = propConsensusOutPacketsMeter, propConsensusOutTrafficMeter
	}
	packets.Mark(1)
	traffic.Mark(int64(msg.Size))
