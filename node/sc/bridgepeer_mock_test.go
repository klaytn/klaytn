...
func (m *MockBridgePeer) SendServiceChainInvalidTxResponse(arg0 []InvalidParentChainTx) error {
	m.ctrl.T.Helper()
...
// SendServiceChainRequestHandleReceipt mocks base method.
func (m *MockBridgePeer) SendServiceChainRequestHandleReceipt(arg0 *RequestHandleReceipt) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendServiceChainRequestHandleReceipt", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}

// SendServiceChainRequestHandleReceipt indicates an expected call of SendServiceChainRequestHandleReceipt.
func (mr *MockBridgePeerMockRecorder) SendServiceChainRequestHandleReceipt(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendServiceChainRequestHandleReceipt", reflect.TypeOf((*MockBridgePeer)(nil).SendServiceChainRequestHandleReceipt), arg0)
}
