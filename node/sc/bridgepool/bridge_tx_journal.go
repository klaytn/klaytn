...
type bridgeTxJournal struct {
	path   string         // Filesystem path to store the transactions at
	writer io.WriteCloser // Output stream to write new transactions into
}

// newBridgeTxJournal creates a new transaction journal to
func newBridgeTxJournal(path string) *bridgeTxJournal {
	return &bridgeTxJournal{
		path: path,
	}
}
...
// the specified pool.
func (journal *bridgeTxJournal) load(add func([]*types.Transaction) []error) error {
...
func (journal *bridgeTxJournal) insert(tx *types.Transaction) error {
...
func (journal *bridgeTxJournal) rotate(all map[common.Address]types.Transactions) error {
...
func (journal *bridgeTxJournal) close() error {
	var err error
