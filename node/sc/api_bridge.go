...
func (sb *SubBridgePrivilegedAPI) AddPeer(url string) (bool, error) {
...
func (sb *SubBridgePrivilegedAPI) RemovePeer(url string) (bool, error) {
	// Make sure the server is running, fail otherwise
	server := sb.subBridge.bridgeServer
	if server == nil {
		return false, node.ErrNodeStopped
...
func (sb *SubBridgePrivilegedAPI) RegisterOperator(bridgeAddr, operatorAddr common.Address) (common.Hash, error) {
	return sb.subBridge.bridgeManager.RegisterOperator(bridgeAddr, operatorAddr)
}

func (sb *SubBridgePrivilegedAPI) SetValueTransferOperatorThreshold(bridgeAddr common.Address, threshold uint8) (common.Hash, error) {
	return sb.subBridge.bridgeManager.SetValueTransferOperatorThreshold(bridgeAddr, threshold)
}

func (sb *SubBridgePrivilegedAPI) DeployBridge() ([]common.Address, error) {
...
func (sb *SubBridgePrivilegedAPI) SubscribeBridge(cBridgeAddr, pBridgeAddr common.Address) error {
...
func (sb *SubBridgePrivilegedAPI) UnsubscribeBridge(cBridgeAddr, pBridgeAddr common.Address) error {
	if !sb.subBridge.bridgeManager.IsValidBridgePair(cBridgeAddr, pBridgeAddr) {
		return ErrInvalidBridgePair
	}
...
func (sb *SubBridgePrivilegedAPI) KASAnchor(blkNum uint64) error {
...
func (sb *SubBridgePrivilegedAPI) Anchoring(flag bool) bool {
	return sb.subBridge.SetAnchoringTx(flag)
}

func (sb *SubBridgePrivilegedAPI) RegisterBridge(cBridgeAddr common.Address, pBridgeAddr common.Address) error {
...
func (sb *SubBridgePrivilegedAPI) DeregisterBridge(cBridgeAddr common.Address, pBridgeAddr common.Address) error {
	if !sb.subBridge.bridgeManager.IsValidBridgePair(cBridgeAddr, pBridgeAddr) {
		return ErrInvalidBridgePair
	}
...
func (sb *SubBridgePrivilegedAPI) RegisterToken(cBridgeAddr, pBridgeAddr, cTokenAddr, pTokenAddr common.Address) error {
	if !sb.subBridge.bridgeManager.IsValidBridgePair(cBridgeAddr, pBridgeAddr) {
		return ErrInvalidBridgePair
	}
...
func (sb *SubBridgePrivilegedAPI) DeregisterToken(cBridgeAddr, pBridgeAddr, cTokenAddr, pTokenAddr common.Address) error {
	cBi, cExist := sb.subBridge.bridgeManager.GetBridgeInfo(cBridgeAddr)
	pBi, pExist := sb.subBridge.bridgeManager.GetBridgeInfo(pBridgeAddr)
...
func (sb *SubBridgePrivilegedAPI) SetERC20Fee(bridgeAddr, tokenAddr common.Address, fee *big.Int) (common.Hash, error) {
	return sb.subBridge.bridgeManager.SetERC20Fee(bridgeAddr, tokenAddr, fee)
}

func (sb *SubBridgePrivilegedAPI) SetKLAYFee(bridgeAddr common.Address, fee *big.Int) (common.Hash, error) {
	return sb.subBridge.bridgeManager.SetKLAYFee(bridgeAddr, fee)
}

func (sb *SubBridgePrivilegedAPI) SetFeeReceiver(bridgeAddr, receiver common.Address) (common.Hash, error) {
...
func (sb *SubBridgePrivilegedAPI) UnlockChildOperator(passphrase string, duration *uint64) error {
...
func (sb *SubBridgePrivilegedAPI) SetParentOperatorFeePayer(feePayer common.Address) error {
...
func (sb *SubBridgePrivilegedAPI) SetChildOperatorFeePayer(feePayer common.Address) error {
...
func (sb *SubBridgePrivilegedAPI) SetParentBridgeOperatorGasLimit(fee uint64) {
