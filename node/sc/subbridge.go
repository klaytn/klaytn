	...
	return []rpc.API{
		{
			...
			Public:    true,
			Ban: rpc.GenerateBanList(sb.APIBackend, []interface{}{
				sb.APIBackend.AddPeer,
				sb.APIBackend.RemovePeer,
				sb.APIBackend.RegisterOperator,
				sb.APIBackend.RegisterOperator,
				sb.APIBackend.SetValueTransferOperatorThreshold,
				sb.APIBackend.DeployBridge,
				sb.APIBackend.SubscribeBridge,
				sb.APIBackend.UnsubscribeBridge,
				sb.APIBackend.KASAnchor,
				sb.APIBackend.Anchoring,
				sb.APIBackend.RegisterBridge,
				sb.APIBackend.DeregisterBridge,
				sb.APIBackend.RegisterToken,
				sb.APIBackend.DeregisterToken,
				sb.APIBackend.SetKLAYFee,
				sb.APIBackend.SetERC20Fee,
				sb.APIBackend.SetFeeReceiver,
				sb.APIBackend.LockParentOperator,
				sb.APIBackend.LockChildOperator,
				sb.APIBackend.UnlockParentOperator,
				sb.APIBackend.UnlockChildOperator,
				sb.APIBackend.SetParentOperatorFeePayer,
				sb.APIBackend.SetChildOperatorFeePayer,
			}),
		},
		{
			Namespace: "subbridge",
